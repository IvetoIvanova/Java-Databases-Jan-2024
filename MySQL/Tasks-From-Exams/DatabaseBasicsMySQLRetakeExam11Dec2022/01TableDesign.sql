...
CREATE TABLE `flights` (
    ...
    `has_delay` BOOLEAN,
    `departure` DATETIME,
    CONSTRAINT fk_flights_countries_departure_country FOREIGN KEY (departure_country)
        REFERENCES countries (id),
	CONSTRAINT fk_flights_countries_destination_country FOREIGN KEY (destination_country)
        REFERENCES countries (id),
