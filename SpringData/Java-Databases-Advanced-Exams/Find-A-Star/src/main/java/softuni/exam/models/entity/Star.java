...
public class Star extends BaseEntity {
    ...
    private Set<Astronomer> observes;
    ...
    public void setStarType(StarType startType) {
    ...
    public Set<Astronomer> getObserves() {
        return observes;
    }

    public void setObserves(Set<Astronomer> observes) {
